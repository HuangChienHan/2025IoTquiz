    ...
    return (
        <div className="max-w-6xl mx-auto">
            <header className="flex justify-between items-center mb-8">
                <h1 className="text-3xl font-bold text-slate-800">題庫清單</h1>
                <span className="text-slate-500">共 {questions.length} 題</span>
            </header>
                ...
                <table className="w-full text-left">
                    <thead className="bg-slate-50 border-b border-slate-100">
                        <tr>
                            ...
                            <th className="p-4 font-medium text-slate-500 w-48 text-right">操作</th>
                        </tr>
                    </thead>
                    <tbody className="divide-y divide-slate-100">
                        {questions.map((q) => (
                            <tr key={q.id} className="hover:bg-slate-50 transition-colors">
                                ...
                                <td className="p-4 text-slate-700 line-clamp-2">
                                ...
                                <td className="p-4 text-right space-x-2">
                                    ...
                                    <button
                                        className="p-2 text-slate-400 hover:text-amber-600 hover:bg-amber-50 rounded-lg transition-colors cursor-not-allowed opacity-50"
                                        title="編輯功能即將推出"
                                    >
                    ...
                    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
                        ...
                        >
                            <div className="p-6 border-b border-slate-100 flex justify-between items-center bg-slate-50">
                                <h2 className="text-xl font-bold text-slate-800">題目詳情</h2>
